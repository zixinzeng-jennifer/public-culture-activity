...
class ShanxiwhySpider(scrapy.Spider):
    ...
    def start_requests(self):
        for i in range(1,5):
            headers = {'Referer': 'https://www.sxggwhy.cn/ts/actList/10',
            'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36',
            ':authority': 'www.sxggwhy.cn',
            ':path':'/activity/getFSingleActivityList.show?menuId=10&pageNum=1&pageSize=6',
            ':scheme':'https',
            'project':"ts",
            'sec-fetch-mode':'cors',
            ...
            url = 'https://www.sxggwhy.cn/activity/getFSingleActivityList.show?menuId=10&pageNum='+str(i)+'&pageSize=6'
            print("-----------第"+str(i)+"页-----------")
    ...
    def event_parse(self, response):
        ...
        for record in records:
            ...
            item['pav_name'] = '山西文化云'
            url = 'https://www.sxggwhy.cn/activity/getFSingleActivityDetail.show?contentId='+str(detail_id)
            ...
            headers1 = {':authority': 'www.sxggwhy.cn',
            ':method': 'GET',
            ':path': '/activity/getFSingleActivityDetail.show?contentId='+str(detail_id),
            'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36',
            ':scheme': 'https',
            'cache-control': 'no-cache',
            'pragma': 'no-cache',
            'project': 'ts',
            'referer': 'https://www.sxggwhy.cn/ts/actDetail/'+str(detail_id),
            'sec-fetch-mode': 'cors',
            'sec-fetch-site': 'same-origin',}
