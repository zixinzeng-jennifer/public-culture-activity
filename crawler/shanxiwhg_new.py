...
class Shanxiwhg_newSpider(scrapy.Spider):
    name = 'shanxiwhg_new'
    def start_requests(self):
        ...
        for i in range(1,8):
            ...
            url = 'https://sxsszwhg.com/article/getArticleList.show?menuId=48&pageNum='+str(i)+'&pageSize=4'
    ...
    def event_parse(self, response):
        ...
        for record in records:
            detail_id = record['id']
            item['pav_name'] = '山西省文化馆'
            item['organizer']=record['organizer']
            url = "https://sxsszwhg.com/article/getPreviewDetial.show?contentId="+ str(detail_id)
            item['url'] = 'https://sxsszwhg.com/sx/newsDetail/'+str(detail_id)
    ...
    def event_text_parse(self, response):
        ...
        item['activity_name'] = result['data']['title']
        ...
        #item['url'] = result
        if result['data']['brief']!= None:
            item['remark'] = result['data']['brief'].replace('\n',' ')
        else:
            item['remark'] = ''
