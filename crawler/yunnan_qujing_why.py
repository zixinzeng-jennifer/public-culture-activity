...
class Yunnan_qujing_whySpider(scrapy.Spider):
    name = 'Yunnan_qujing_why'
    ...
    def start_requests(self):
        for i in range(1,8):
            headers = {'Host': 'www.whqj.gov.cn',
            'Referer': 'http://www.whqj.gov.cn/qj/user_activityMore/',
            ...
            url = 'http://www.whqj.gov.cn/activity/getFActivitySearch.show?activityTime=0&pageNum='+str(i)+'&pageSize=10&sort=4&statusInfo=&title='
            print("-----------第"+str(i)+"页-----------")
    ...
    def event_parse(self, response):
        ...
        for record in records:
            ...
            item['pav_name'] = '云南曲靖文化云'
            item['activity_name'] = record['title']
            url = 'http://www.whqj.gov.cn/activity/getFActivityDetailForJoin.show?id='+str(detail_id)
            item['url'] = 'http://www.whqj.gov.cn/qj/user_activityDetail/'+str(detail_id)
            item['place'] = record['address']
            item['activity_type'] = record['labelList'][0]['labelName']
